...
export async function Rainfall(pushToken, uid, daysFromToday) {
  try {
    const messageBody = `Expect rain in another ${daysFromToday} days!`;
    ...
    console.error('Error in Rainfall function:', error);
  }
}
