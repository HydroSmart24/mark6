...
export async function WaterRequest(pushToken, uid, eta) {
  try {
    const messageBody = `Water on the way! Your water will be delivered in ${eta}`;

    // Construct the notification content
    const notificationContent = {
      title: 'Your water is on the way!',
      body: messageBody,
    };
